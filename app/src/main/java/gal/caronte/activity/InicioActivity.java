...
import gal.caronte.custom.sw.ComprobarLoginGoogleCustom;
import gal.caronte.custom.sw.Conta;
import gal.caronte.custom.sw.EdificioCustom;
import gal.caronte.servizo.ComprobarUsuarioGoogle;
import gal.caronte.servizo.RecuperarConta;
import gal.caronte.servizo.RecuperarEdificio;
...
public class InicioActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(getString(R.string.title_activity_inicio));
    ...
    private void handleSignInResult(GoogleSignInResult result) {
        if (result.isSuccess()) {
            Toast.makeText(this, getString(R.string.usuario_logueado), Toast.LENGTH_SHORT).show();
            //Usuario logueado
